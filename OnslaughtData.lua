		...
		Encounter =
		{
			...
			SpawnWaves =
			{
				-- wave 1
				{
					Spawns =
					{
						{ Name = "FlurrySpawner", TotalCount = 3, },
					},
				},
				-- wave 2
				{
					Spawns =
					{
						{ Name = "FlurrySpawnerElite", TotalCount = 2, },
					},
				},
				-- wave 3
				{
					Spawns =
					{
						{ Name = "FlurrySpawnerElite", TotalCount = 4, },
					},
				},
				-- wave 4
				{
					Spawns =
					{
						{ Name = "FlurrySpawner", TotalCount = 5, },
						{ Name = "FlurrySpawnerElite", TotalCount = 2, },
						{ Name = "FlurrySpawnerSuperElite", TotalCount = 1, },
					},
				},
			},
		},
